...
def player1_vs_player2(player1_name, player2_name):
    ...
    # Choose font
    font = pygame.font.SysFont(None, 100)  # Bigger font for full screen

    # Render text
    player1_text = font.render(player1_name, True, (255, 255, 255))
    player2_text = font.render(player2_name, True, (255, 255, 255))
